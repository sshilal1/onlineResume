var resume = {
    ...
    tools : {
        webdev : {
            front : ["React",,"Javascript ES6","HTML","CSS","Sass","jQuery","Bootstrap","MaterialUI"],
            back : ["Node","Express","Npm","PHP","Socket.io","MongoDB","MySQL"]
        },
        generic : ["MVC","Git","AWS EC2","AWS RDS","Powershell","C#"]
    }
}